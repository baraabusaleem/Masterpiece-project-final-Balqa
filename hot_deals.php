    ...
    if ($ok == 1) {
        if (isset($_SESSION['cart'])) {
            ...
            if (in_array($_POST['add_to_cart_id'], $items)) {
               ...
               // header("location:hot_deals.php?id={$_GET['id']}");
				...
				<div class="row">
						...
						<div class="aside">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">$30.00 <del class="product-old-price">$30.00</del></h4>
								</div>
							</div>
						</div>
						<!-- /aside Widget -->
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							$query = "SELECT * FROM products where product_keywords='deal' AND product_price BETWEEN $min AND $max";
							$con->query($query);
