    ...
    if ($ok == 1) {
        ...
        if (isset($_SESSION['cart'])) {
            ...
            if (in_array($_POST['add_to_cart_id'], $items)) {
              ...
              //  header("location:camera.php?id={$_GET['id']}");
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/32-channel-nvr-4k-w-16-poe_1.jpg" alt="">
								</div>
								<div class="product-body">
									<p class="product-category">Dvers</p>
									<h3 class="product-name"><a href="product.php?product_id=48">HOT SWAP 64 CHANNEL 4K NVR</a></h3>
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h3 class="product-name"><a href="product.php?product_id=14">LENOVO IDEAPAD L340 GAMING camera CORE I7 9GEN W/ GTX 1650 16GB
</a></h3>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							$query = "SELECT * FROM products where product_keywords='camera' AND product_price BETWEEN $min AND $max";
							$con->query($query);
