			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +962790578453</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> barafabusaleem@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> salt </a></li>
					</ul>
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="index.php" class="logo">
									<br><br>
									<H1 class="white">protection<span class="red"></span></H1>
								</a>
							</div>
						</div>
						<!-- /LOGO -->
